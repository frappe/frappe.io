...
Login to IDP
<img class="screenshot" src="~@frappe_base/assets/img/00-login-to-idp.png">

Add OAuth Client on IDP
<img class="screenshot" src="~@frappe_base/assets/img/01-add-oauth-client-on-idp.png">

Set Server URL on IDP
<img class="screenshot" src="~@frappe_base/assets/img/02-set-server-url-on-idp.png">

### Part 2 : on Frappe App Server


Set `Frappé Client ID`  and `Frappé Client Secret` on App server (refer the client set on IDP)
<img class="screenshot" src="~@frappe_base/assets/img/03-set-clientid-client-secret-server-on-app-server.png">
...
<img class="screenshot" src="~@frappe_base/assets/img/04-login-screen-on-app-server.png">

### Part 3 : Redirected on IDP

login with user on IDP
<img class="screenshot" src="~@frappe_base/assets/img/05-login-with-user-on-idp.png">

Confirm Access on IDP
<img class="screenshot" src="~@frappe_base/assets/img/06-confirm-grant-access-on-idp.png">

### Part 4 : Back on App Server

Logged in on app server with ID from IDP
<img class="screenshot" src="~@frappe_base/assets/img/07-logged-in-as-website-user-with-id-from-idp.png">

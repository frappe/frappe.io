...
<img class="screenshot" alt="New Data Migration Plan" src="~@frappe_base/assets/img/data-migration/new-data-migration-plan.png">
...
<img class="screenshot" alt="New Data Migration Mapping" src="~@frappe_base/assets/img/data-migration/new-data-migration-mapping.png">
...
<img class="screenshot" alt="Add fields in Data Migration Mapping" src="~@frappe_base/assets/img/data-migration/new-data-migration-mapping-fields.png">

We can now add the 'Item to Atlas Item' mapping to our Data Migration Plan and save it.

<img class="screenshot" alt="Save Atlas Sync Plan" src="~@frappe_base/assets/img/data-migration/atlas-sync-plan.png">
...
<img class="screenshot" alt="Mapping __init__.py" src="~@frappe_base/assets/img/data-migration/mapping-init-py.png">
...
<img class="screenshot" alt="Pre and Post Process" src="~@frappe_base/assets/img/data-migration/mapping-pre-and-post-process.png">

### Data Migration Connector
Now, to connect to the remote source, we need to create a *Data Migration Connector*.

<img class="screenshot" alt="New Data Migration Connector" src="~@frappe_base/assets/img/data-migration/new-connector.png">

We only have two connector types right now, let's add another Connector Type in the Data Migration Connector DocType.

<img class="screenshot" alt="Add Connector Type in Data Migration Connector" src="~@frappe_base/assets/img/data-migration/add-connector-type.png">

Now, let's create a new Data Migration Connector.

<img class="screenshot" alt="Atlas Connector" src="~@frappe_base/assets/img/data-migration/atlas-connector.png">
...
<img class="screenshot" alt="Atlas Connection file" src="~@frappe_base/assets/img/data-migration/atlas-connection-py.png">

After creating the Atlas Connector, we also need to import it into `data_migration_connector.py`

<img class="screenshot" alt="Edit Connector file" src="~@frappe_base/assets/img/data-migration/edit-connector-py.png">
...
<img class="screenshot" alt="Data Migration Run" src="~@frappe_base/assets/img/data-migration/data-migration-run.png">

...
<img class="screenshot" alt="Doctype Saved" src="~@frappe_base/assets/img/naming_doctype.png">
...
<img class="screenshot" alt="Autonaming and Search Field" src="~@frappe_base/assets/img/autoname_and_search_field.png">
...
<img class="screenshot" alt="Link Field" src="~@frappe_base/assets/img/link_field.png">

For select fields, as we mentioned earlier, add the various options in the **Options** input box, each option on a new row.

<img class="screenshot" alt="Select Field" src="~@frappe_base/assets/img/select_field.png">
...
<img class="screenshot" alt="Fetch values" src="~@frappe_base/assets/img/fetch.png">
...
<img class="screenshot" alt="Article" src="~@frappe_base/assets/img/doctype_article.png">

#### Library Member

<img class="screenshot" alt="Library Member" src="~@frappe_base/assets/img/doctype_lib_member.png">

#### Library Membership

<img class="screenshot" alt="Library Membership" src="~@frappe_base/assets/img/doctype_lib_membership.png">

#### Library Transaction

<img class="screenshot" alt="Library Transaction" src="~@frappe_base/assets/img/doctype_lib_trans.png">

...
<img class="screenshot" alt="Add User Roles" src="~@frappe_base/assets/img/add_user_roles.png">
...
<img class="screenshot" alt="Library Management Module" src="~@frappe_base/assets/img/lib_management_module.png">
...
<img class="screenshot" alt="New Article" src="~@frappe_base/assets/img/new_article_blank.png">
...
<img class="screenshot" alt="New Article" src="~@frappe_base/assets/img/new_article.png">

You can also add an image.

<img class="screenshot" alt="Attach Image" src="~@frappe_base/assets/img/attach_image.gif">

Now let us create a new member:

<img class="screenshot" alt="New Library Member" src="~@frappe_base/assets/img/new_member.png">
...
<img class="screenshot" alt="New Library Membership" src="~@frappe_base/assets/img/new_lib_membership.png">
...
<img class="screenshot" alt="System Settings" src="~@frappe_base/assets/img/system_settings.png">
